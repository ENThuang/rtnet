...
from ..layers.feature_pyramid_network import (
    ExtraFPNBlock,
    FeaturePyramidNetwork,
    LastLevelMaxPool,
)

from ..backbones import mobilenetv3_3d as mobilenet
from ..backbones import resnet_3d as resnet
...
def resnet_fpn_backbone(
    ...
    **kwargs,
    ...
    """
    backbone = resnet.__dict__[backbone_name](norm_layer=norm_layer, **kwargs)
...
def mobilenet_backbone(
    ...
    **kwargs,
    ...
    backbone = mobilenet.__dict__[backbone_name](norm_layer=norm_layer, **kwargs)
...
def _mobilenet_extractor(
    backbone: mobilenet.MobileNetV3_3d,
    fpn: bool,
    trainable_layers: int,
    returned_layers: Optional[List[int]] = None,
    extra_blocks: Optional[ExtraFPNBlock] = None,
