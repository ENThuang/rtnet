...
def augment_gaussian_noise(
    ...
    if not per_channel:
        variance = (
            ...
            else random.uniform(noise_variance[0], noise_variance[1])
        )
    else:
        variance = None
    ...
    if not per_channel:
        ...
        sigma = (
            ...
            if (
                ...
                or ((np.random.uniform() < p_isotropic) and different_sigma_per_axis)
            )
...
def augment_blank_square_noise(
    data_sample,
    square_size,
    n_squares,
    noise_val=(0, 0),
    ...
    data_sample = mask_random_squares(
        data_sample,
