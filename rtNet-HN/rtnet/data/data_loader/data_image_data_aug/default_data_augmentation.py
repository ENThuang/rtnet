...
#     from rtnet.data.data_loader.data_image_dataloading.dataset_loading import load_dataset
...
#     import json
#
#     t = "Task002_CE_AnchorOrganGuided_LNS"
#     p = os.path.join(preprocessing_output_dir, t)
#     dataset = load_dataset(p, 0)
#     with open(os.path.join(p, "rtNetPlans_plans_3D.json"), 'r') as f:
#         plans = json.load(f)
#
#     basic_patch_size = get_patch_size(np.array(plans['plans_per_stage']["0"]['patch_size']),
